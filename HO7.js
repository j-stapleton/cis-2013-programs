...
//lines 12-18 declares and sets variables with respective DOM input. lines 19-25 declare variables needed for calculations
	...
	var floatRectArea = parseFloat($("rect_area").value);
	var floatRectPerim = parseFloat($("rect_perim").value);
	var floatS = parseFloat($("S").value);
	var floatTriangleArea = parseFloat($("triangle_area").value);
	var floatTrianglePerim = parseFloat($("triangle_perim").value);
	var floatCircleArea = parseFloat($("circle_area").value);
	var floatCircleCircum = parseFloat($("circle_circum").value);	
...
//    $("radius").value = "";
    ...
    $("calc_triangle_perim").onclick = calcTrianglePerim;
